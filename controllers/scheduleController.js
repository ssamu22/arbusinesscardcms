...
exports.getSchedule = async (req, res) => {
  ...
  try {
    ...
    const consultationTypes = await Consultation_type.getAllConsultationType(
      employee_id
    ); // Fetch consultation types of employee from the database
...
exports.updateTypes = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Failed to update or insert consultation types" });
  }
};
